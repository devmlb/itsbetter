...
// let html = `
// <div class="itsbetter-update-msg" style="position: fixed; bottom: 0px; right: 0px;">
//     <meta charset="UTF-8">
//     <!-- <link rel="stylesheet" href="%mdui-css%"> -->
//     <!-- <script src="%mdui-js%"></script> -->
//     <link href="%material-icons-css%" rel="stylesheet">
...
//     </script>
//     <mdui-card variant="elevated"
//         style="padding: 20px; display: flex; width: auto; align-items: center;">
//         <img src="%itsbetter-icon%" style="width: 50px; height: 50px; margin-right: 30px;">
//         <div>
//             <h1 style="margin-block-start: 10px; margin-block-end: 0px;">ItsBetter a été mise à jour !</h1>
//             <div style="display: flex; align-items: center;">
...
//                 <p style="margin-bottom: 10px;">Ajout 1</p>
//                 <p style="margin-bottom: 10px;">Ajout 2</p>
//                 <p style="margin-bottom: 10px;">Ajout 3</p>
//             </div>
//             <div style="display: flex; width: auto; align-items: center; justify-content: right;">
//                 <mdui-button id="close-button" style="margin-right: 5px;" variant="text">Fermer</mdui-button>
//                 <mdui-button style="margin-left: 5px;" end-icon="open_in_new--rounded"
//                     href="https://dev-mlb.alwaysdata.net/" target="_blank">Ouvrir les paramètres</mdui-button>
//             </div>
//         </div>
//     </mdui-card>
// </div>
...
// // head.innerHTML += `<link rel="stylesheet" href="`+chrome.runtime.getURL("mdui/mdui-update.css")+`"></link>
// // <script src="`+chrome.runtime.getURL("mdui/mdui.global.js")+`"></script>
// // `
// html = html.replace("%mdui-css%", chrome.runtime.getURL("mdui/mdui-update.css"));
// html = html.replace("%mdui-js%", chrome.runtime.getURL("mdui/mdui.global.js"));
...
// html = html.replace("%script%", mduiScript);
// body.innerHTML += html